        ...
        <main className="">
            <motion.div
                    ...
                    <div
                        ...
                        <div className="md:w-1/2">
                            ...
                            >
                                ...
                                efficient document retrieval, seamlessly integrates with X.com API, performs web
                                searches, generates images, and offers a wide range of advanced capabilities to enhance
                                your conversational interactions.
                            </motion.p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-card border  rounded-lg p-6 md:w-2/3 shadow-lg mx-3">
                    ...
                    <p className="mb-6">
                        Elevate your productivity with CNTRL AI Chat. Experience AI-assisted planning and achieve
