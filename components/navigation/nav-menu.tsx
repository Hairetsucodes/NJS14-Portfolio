                ...
                <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                  <li className="row-span-3">
                    <NavigationMenuLink asChild>
                      <a
                        className="flex h-full w-full select-none flex-col hover:bg-slate-700 justify-end rounded-md bg-gradient-to-b from-muted/50 to-muted p-6 no-underline outline-none focus:shadow-md"
                        href={"/portfolio"}
                      >
                        ...
                        <p className="text-sm leading-tight text-muted-foreground">
                          A list of all the projects that I have built in the
                          last year. AI has been the focus of them all from
                          component creation, project planning and chat bots.
                        </p>
                      </a>
                    </NavigationMenuLink>
                  </li>
                  <ListItem href="/hiringfm" title="HiringFM">
                    HiringFM is a platform that helps you find your dream job.
                  </ListItem>
                  <ListItem href="/decipher" title="Decipher">
                    Decipher is a powerful server-side tool designed to protect
                    high-traffic applications from fraud and spam.
                  </ListItem>
                  <ListItem href="/chat" title="Chat">
                    CNTRL AI is a chat-bot that can help you with your
                    questions.
                  </ListItem>
            ...
            session?.user?.role === "AUTHOR" ? (
              <>
                <DropdownMenu>
                  <DropdownMenuTrigger
                    className={
                      "border border-input bg-background shadow-sm hover:bg-accent hover:text-accent-foreground p-[.35rem] rounded-lg"
                    }
                  >
